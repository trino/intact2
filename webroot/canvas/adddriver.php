...
$_GET['num']=100;?>
		...
		<script src="/canvas/jquery.jqscribble.js" type="text/javascript"></script>
		<script src="/canvas/jqscribble.extrabrushes.js" type="text/javascript"></script>
        ...
        <div class="col-sm-10" style="width: 500px;padding:0px;">
      ...
      $(function(){
        ...
        $("#test" + numb).data("jqScribble").save(function (imageData) {
                ...
                $.post('/canvas/image_save.php', {imagedata: imageData}, function (response) {
                    if(response=='')
                    {
