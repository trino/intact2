<link type="text/css" rel="stylesheet"
      href="<?php echo $this->request->webroot; ?>assets/admin/pages/css/profile.css"> <!--REQUIRED-->
<style>
    @media print {
        .page-header {
            display: none;
...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Profiles Scorecard
                <small>Broker View</small>
            </h1>
        </div>
                                ...
                                <div class="portlet light profile-sidebar-portlet">
                                    ...
                                    <div style="max-width:250px;margin:0 auto;" class="profile-userpic">
                                        <img src="<?php echo $this->request->webroot; ?>img/profile/default.png"
                                             style="height: auto;" alt="" id="clientpic" class="img-responsive">
                                    ...
                                    <div class="profile-usertitle">
                                        ...
                                        <label style="margin-bottom:10px;" class="uniform-inline">
                                            <div class="checker disabled" id="uniform-888">
                                                <span class="checked"><input type="checkbox" checked=""
                                                                             disabled="disabled" class="checkhiredriver"
                                                                             id="888" value="1" name="stat"></span>
                                            </div>
                                            Intact Policy or Quote# <span class="hired_msg"></span>
                                        </label><br>
                                        <a style="margin-top:2px;width:80%;" class="btn floatleft grey-cascade addpro"
                                           href="<?php echo $this->request->webroot; ?>orders/productSelection?driver=888&amp;ordertype=CAR">Order
                                            Products A La Carte <i class="m-icon-swapright m-icon-white"></i></a>
                                        <a style="margin-top:2px;width:80%;" class="btn floatleft grey-cascade addpro"
                                           href="javascript:void(0)">Criminal Record Check <i
                                                class="m-icon-swapright m-icon-white"></i></a>
                                        <a style="margin-top:2px;width:80%;" class="btn floatleft grey-cascade addpro"
                                           href="javascript:void(0)">Transclick <i
                                                class="m-icon-swapright m-icon-white"></i></a>
                                        <a style="margin-top:2px;width:80%;" class="btn floatleft grey-cascade addpro"
                                           href="javascript:void(0)">Social Media Search <i
                                                class="m-icon-swapright m-icon-white"></i></a>
                                        ...
                                        <div class="tabbable tabbable-custom">
                                            ...
                                            <div style="padding: 0;" class="tab-content">
                                                ...
                                                <div style="padding: 10px;" id="tab_1_1" class="tab-pane   ">
                                                    ...
                                                    <!--span style="color:red;">subpages/profile/info.php #INC117</span-->
                                                    <script>var reasons = false; //Action is: view</script>
                                                    <div class="portlet-body form">
                                                        <input type="hidden" class="client_profile_id" value=""
                                                               name="client_ids">
                                                            ...
                                                            <div class="tab-content">
                                                                <div id="subtab_4_1" class="tab-pane active">
                                                                    ...
                                                                    <div style="margin-bottom:0px;" class="portlet box">
                                                                        ...
                                                                        <form id="save_clientz" method="post" action=""
                                                                              role="form">
                                                                            <input type="hidden"
                                                                                   class="client_profile_id" value=""
                                                                                   name="client_ids">
                                                                            <input type="hidden" id="profile_drafts"
                                                                                   value="0" name="drafts">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div style="display:;"
                                                                                     class="col-md-6 hired_date">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Hired
                                                                                            Date:</label>
                                                                                        <input type="text"
                                                                                               class="form-control date_hired"
                                                                                               disabled="disabled"
                                                                                               value="2015-09-02"
                                                                                               name="hired_date">
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Profile
                                                                                            Type:</label>
                                                                                ...
                                                                                <div style="display:
                                                                  none                                     ;"
                                                                                     id="isb_id" class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">ISB
                                                                                            ID: </label>
                                                                                ...
                                                                                <div class="clearfix"></div>
                                                                                <div style="display:none"
                                                                                     class="col-md-6 hideusername admin_rec">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Username: </label>
                                                                                        <input type="text"
                                                                                               value="Owner_Operator_888"
                                                                                               class="form-control req_driver req_rec uname"
                                                                                               onkeyup="emailthecreds();"
                                                                                               name="username"
                                                                                               id="username_field"
                                                                                               disabled="disabled">
                                                                                        <span style="display: none;"
                                                                                              class="error passerror flashUser">Username exists already</span>
                                                                                        <span style="display: none;"
                                                                                              class="error passerror flashUser1">Username is required</span>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Email
                                                                                            Address: </label>
                                                                                        <input type="email"
                                                                                               value="bhills_1240@mailinator.com"
                                                                                               class="form-control un email req_driver req_rec req_sales"
                                                                                               role="email" id="email"
                                                                                               onkeyup="emailthecreds();"
                                                                                               name="email"
                                                                                               disabled="disabled">
                                                                                        <span style="display: none;"
                                                                                              class="error passerror flashEmail">This email address is already in use</span>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="clearfix"></div>
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Title:</label><br><select
                                                                                            class="form-control "
                                                                                            name="title"
                                                                                            disabled="disabled">
                                                                                            <option value="Mr">Mr.
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <label class="control-label">Country
                                                                                            of Birth: </label>
                                                                                        <input type="text" value="Kxoer"
                                                                                               class="form-control req_driver placeofbirth"
                                                                                               placeholder=""
                                                                                               name="placeofbirth"
                                                                                               disabled="disabled">
                                                                                    </div>
                                                ...
                                                <input < php echo $is_disabled ?> name="province" type="text"
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <input type="text"
                                                                                               ...
                                                                                               name="postal"
                                                                                               class="form-control req_driver"
                                                                                               placeholder="Postal Code (M5V2X2)"
                                                                                               disabled="disabled">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div style="display:block"
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                class="control-label">Province
                                                                                                issued: </label>

                                                                                            <select
                                                                                                class="form-control req_driver"
                                                                                                name="driver_province"
                                                                                                disabled="disabled">
                                                                                                <option value="">Select
                                                                                                    Province
                                                                                                </option>
                                   ...
                                   <div class="form-group col-md-12">
                                       ...
                                       <a href="javascript:void(0)" class="btn btn-info" id="addMoredoc">
                                        ...
                                        Save As Draft
                                                                                    ...
                                                                                    <input type="submit" id="hiddensub"
                                                                                           style="display: none;">
                                                                                </div>
...
//$('.flashimg').show();
                                                            ...
                                                            <div class=" light recruiter_notes"
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <textarea class="form-control" rows="2"
                                                                              placeholder="Add driver notes here..."
                                                                              id="recruiter_notes"></textarea>
                                                                    <a style="float:right;margin:5px 0;"
                                                                       id="add_recruiter" class="btn btn-success"
                                                ...
                                                <div style="padding: 10px;" id="tab_1_11" class="tab-pane  active">
                                                    ...
                                                    <!--span style="color:red;">subpages/documents/forview.php #INC144</span><br-->
                                                    <!-- BEGIN PROFILE CONTENT -->
                                                    <div class="row">
                                                        <div class="clearfix"></div>
                                                        <div class="col-md-12"><!-- BEGIN PORTLET -->
                                                            <div class="portlet">
                                                                        ...
                                                                        <div style="margin-bottom: 8px;"
                                                                             class="col-md-12"><h4
                                                                                style="margin-left: -7px;"><i
                                                                                    class="icon-doc font-blue-hoki"></i><span
                                                                                    class="caption-subject bold font-blue-hoki uppercase"> Documents Submitted</span>
                                                                            </h4></div>
                                                                        <table style="margin-bottom: 0px;"
                                                                               class="table">
                                                                            <tbody>
                                                                            <tr role="row" class="even">
                                                                                <td><span class="icon-notebook"></span>
                                                                                </td>
                                                                                <td>
                                                                                    <a href="<?php echo $this->request->webroot; ?>documents/view/41/2024/?type=18">Application
                                                                                        for Insurance</a></td>
                                                                                <td class="actions"><span
                                                                                        class="label label-sm label-success"
                                                                                        style="">Submitted</span></td>
                                                                                <td></td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <div class="portlet box yellow">
                                                                        <div class="portlet-title">
                                                                            <div class="caption">
                                                                                ...
                                                                                <i class="fa fa-folder-open-o"></i>Order
                                                                                Score Sheet - 2015-09-02 11:51:40
                                                                            </div>

                                                                            <a class="btn  small"
                                                                               href="<?php echo $this->request->webroot; ?>orders/vieworder/41/823?order_type=REQ?forms=1,14,72"
                                                                               style="float:right; display:none;">View
                                                                                Order</a>
                                                                        </div>
                                                                        <div class="portlet-body">
                                                                            <div oldclass="table-scrollable">
                                                                                ...
                                                                                <div class="col-sm-12">
                                                                                    <table
                                                                                        class="table-condensed table-striped table-bordered table-hover dataTable no-footer">
                                                                                        <tbody>
                                                                                        <tr>
                                                                                            <th colspan="3">Order
                                                                                                Information (ID: 823)
                                                                                        ...
                                                                                        <tr>
                                                                                            <th width="25%">Created on
                                                                                            </th>
                                                                                            <td colspan="2">2015-09-02
                                                                                                11:51:40
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th>Completed Date</th>
                                                                                            <td colspan="2">2015-12-02
                                                                                                11:51:40
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th>Submitted by</th>
                                                                                            <td colspan="2">Deleted or
                                                                                                Missing Data
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <a href="<?php echo $this->request->webroot; ?>profiles/view/888"
                                                                                                   class="nohide">Beverly
                                                                                                    Hills (Beverly)</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                    ...
                    Products Ordered </span></h4>
                                                                                ...
                                                                                <div style="" class="col-md-12">
                                                                                    <table style="margin-bottom: 0px;"
                                                                                        ...
                                                                                        <tr role="" class="">
                                                                                            ...
                                                                                            <td><span
                                                                                                    class="label label-success">Pass</span>
                                                                                            </td>
                                                                                        ...
                                                                                        <tr role="" class="">
                                                                                            ...
                                                                                            <td><span
                                                                                                    class="label label-danger">Fail</span>
                                                                                            </td>
								...
								Documents Submitted </span></h4>
                                                                                    ...
                                                                                    <table
                                                                                        class="table-condensed table-striped table-bordered table-hover dataTable no-footer"></table>
     ...
     <li >
        <a href="#tab_1_13" data-toggle="tab">Client Types</a>
                                                    ...
                                                    <div class="portlet-body form">
                                                        <div class="tab-content">
                                                            <div style="padding: 10px;" id="subtab_2_1"
                                                                                ...
                                                                                <td>
                                                                                    <div class="checker disabled"
                                                                                        ...
                                                                                        <span><input type="checkbox"
                                                                                                     id="sellall1"
                                                                                                     disabled="disabled"
                                                                                                     class="slelectall"></span>
                                                                                    </div>
                                                                                    <label for="sellall1"> Select
                                                                                        All</label></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="vtop">
                                                                                ...
                                                                                <td width="90%">
                                                                                    <label class="uniform-inline">
                                                                                        <div class="radio disabled">
                                                                                            <span><input type="radio"
                                                                                                         onclick="$('.ptypes').show();$(this).closest('td').find('.yesno span').each(function(){$(this).addClass('checked')});$(this).closest('td').find('.yesno input').each(function(){ this.checked = true;})"
                                                                                                         value="1"
                                                                                                         name="side[profile]"
                                                                                                         class="profile_enb"
                                                                                    ...
                                                                                    <label class="uniform-inline">
                                                                                        <div class="radio disabled">
                                                                                            <span><input type="radio"
                                                                                                         onclick="$('.ptypes').hide(); $(this).closest('td').find('.yesno span').each(function(){$(this).removeClass('checked')});$(this).closest('td').find('.yesno input').each(function(){ this.checked = false;})"
                                                                                                         value="0"
                                                                                                         name="side[profile]"
                                                                                                         disabled="disabled"></span>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="clearfix"></div>
                                                                                    <div
                                                                                        class="col-md-12 nopad martop yesno">
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                                class="checker disabled">
                                                                                                <span><input
                                                                                                        type="checkbox"
                                                                                                        value="1"
                                                                                        ...
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                                ...
                                                                                                <span><input
                                                                                                        type="checkbox"
                                                                                                        value="1"
                                                                                                        name="side[email_profile]"
                                                                                                        disabled="disabled"></span>
                                                                                            </div>
                                                                                            Receive Email (on create
                                                                                            profile)
                                                                                        </label>
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                    ...
                                                                                    <table
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="titleptype_1"
                                                                                                ...
                                                                                                <label for="cchk_1">Admin</label>
                                                                                            </td>
                                                                                            <td class="titleptype_2"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_2">
                                                                                                ...
                                                                                                <label for="cchk_2">Recruiter</label>
                                                                                            </td>
                                                                                            <td class="titleptype_3"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_3">
                                                                                                ...
                                                                                                <label for="cchk_3">External</label>
                                                                                            </td>
                                                                                            <td class="titleptype_5"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_5">
                                                                                                ...
                                                                                                <label for="cchk_5">Driver</label>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="titleptype_7"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_7">
                                                                                                ...
                                                                                                <label for="cchk_7">Owner
                                                                                                    Operator</label>
                                                                                            </td>
                                                                                            <td class="titleptype_8"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_8">
                                                                                                ...
                                                                                                <label for="cchk_8">Owner
                                                                                                    Driver</label>
                                                                                            </td>
                                                                                            <td class="titleptype_9"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_9">
                                                                                                ...
                                                                                                <label for="cchk_9">Employee</label>
                                                                                            </td>
                                                                                            <td class="titleptype_12"
                                                                                                style="width:25%;">
                                                                                                <div
                                                                                                    class="checker disabled"
                                                                                                    id="uniform-cchk_12">
                                                                                        ...
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                                ...
                                                                                                <span><input
                                                                                                        ...
                                                                                                        value="1"
                                                                                                        class="create3"
                                                                                                        onclick="selectall('side[orders_mee]', 'create3'); selectall('side[orders_products]', 'create3'); selectall('side[bulk]', 'create3'); selectall('side[]', 'create3'); selectall('side[orders_emp]', 'create3'); selectall('side[orders_sal]', 'create3'); selectall('side[orders_gdo]', 'create3'); "
                                                                                        ...
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                                ...
                                                                                                <span><input
                                                                                                        type="checkbox"
                                                                                                        value="1"
                                                                                                        name="side[orders_mee]"
                                                                                                        disabled="disabled"></span>
                                                                                            </div>
                                                                                            Driver Order</label> <label
                                                                                            class="uniform-inline">
                                                                                            <div
                                                                                                class="checker disabled">
                                                                                                <span><input
                                                                                                        type="checkbox"
                                                                                                        value="1"
                                                                                                        name="side[orders_products]"
                                                                                                        disabled="disabled"></span>
                                                                                            </div>
                                                                                            Order Products A La
                                                                                            Carte</label> <label
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <span><input
                                                                                                        type="checkbox"
                                                                                                        value="1"
                                                                                                        name="side[orders_emp]"
                                                                                                        disabled="disabled"></span>
                                                                                            </div>
                                                                                            GFS Employee Order</label>
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                                class="checker disabled">
                                                                                                <span><input
                                                                                                        type="checkbox"
                                                                                                        value="1"
                                                                                                        name="side[orders_sal]"
                                                                                                        disabled="disabled"></span>
                                                                                            </div>
                                                                                            GFS Sales Order</label>
                                                                                        <label class="uniform-inline">
                                                                                            <div
                                                                                                class="checker disabled">
                                                                                                <span><input
                            ...
                            <td>
                                ...
                                <label class="uniform-inline">
                                    ...
                                    No </label>
                                                            ...
                                                            <div style="padding: 10px;" id="subtab_2_3"
                                                                 class="tab-pane">
                                                                ...
                                                                <form id="homeform">
                                                                    ...
                                                                    <table class="table table-bordered table-hover">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="checker disabled"
                                                                                     id="uniform-sellall2"><span><input
                                                                                            type="checkbox"
                                                                                            id="sellall2"
                                                                                            disabled="disabled"
                                                                                            class="slelectall1"></span>
                                                                                </div>
                                                                                <label for="sellall2"> Select
                                                                                    All</label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                ...
                                                <td>
                                                    ...
                                                    <label class="uniform-inline">
                                                        ...
                                                        No </label>
                                                            ...
                                                            <div style="padding: 10px;" id="subtab_2_4"
                                                                 class="tab-pane ">
                                            ...
                                            <div class="portlet box">
                                                ...
                                                <div class="portlet-body">-->
                                                                <input type="text" disabled="disabled"
                                                                       class="form-control" onkeyup="searchClient()"
                                                                       id="searchClient">
                                                                ...
                                                                <div class="slimScrollDiv"
                                                                    ...
                                                                    <div class="scrolldiv"
                                                                        ...
                                                                        <div class="slimScrollDiv"
                                                                             style="position: relative; overflow: hidden; width: auto; height: 250px;">
                                                                            <table
                                                                                style="border-width: medium 1px 1px; border-style: none solid solid; border-color: -moz-use-text-color rgb(229, 229, 229) rgb(229, 229, 229); -moz-border-top-colors: none; -moz-border-right-colors: none; -moz-border-bottom-colors: none; -moz-border-left-colors: none; border-image: none; overflow: hidden; width: auto; height: 250px;"
                                                                                id="clientTable"
                                                                                class="table scrolldiv">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="50"
                                                                                        style="border-top:none;"><img
                                                                                            style="max-width: 50px;"
                                                                                            src="<?php echo $this->request->webroot; ?>img/logos/MEELogo.png">
                                                                                    </td>
                                                                                    <td style="border-top:none;">
                                                                                        <label for="c_0">Challenger
                                                                                            Motor Freight </label><span
                                                                                            class="msg_17"></span></td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <label for="c_2">Gordon Food
                                                                                            Service</label><span
                                                                                            class="msg_26"></span></td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <label for="c_4">Patriot Source
                                                                                            1</label><span
                                                                                            class="msg_37"></span></td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <label for="c_5">Revolution
                                                                                            Staffing</label><span
                                                                                            class="msg_38"></span></td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <label for="c_6">Huron Services
                                                                                            Group</label><span
                                                                                            class="msg_41"></span></td>
                                                                                </tr>
                                                                ...
                                                                <div style="display: none;"
                                                                     class="margin-top-10 alert alert-success display-hide clientadd_flash">
