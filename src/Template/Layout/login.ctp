...
<div class="content">
       <center>
            	<img src="<?php echo $this->request->webroot.'img/logos/ISBWhite.png'?>"  style="max-width: 100%; "  /></center>
...
<script src="<?php echo $this->request->webroot;?>assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
...
<script src="<?php echo $this->request->webroot;?>assets/admin/pages/scripts/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
