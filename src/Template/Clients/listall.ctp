            ...
            <div class="col-md-12">
                <div class="portlet box">
                    <div class="portlet-body form">
                        <form align="right" class="form-actions" method="get" action="<?= $this->request->webroot; ?>clients/search" style="border-top: 0;">
                            <div align="right">
                                <input type="search" aria-controls="sample_1" value="" placeholder="Search Clients" name="search" class="form-control input-inline">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="<?php echo $this->request->webroot; ?>clients/edit/41?view">
                                                    <img src="<?php echo $this->request->webroot; ?>img/logos/huron.jpg" id="clientpic" style="max-width:180px;max-height:50px;width: auto; height: auto;" class="img-responsive">
                                                </a>
                                            </td>

                                            <td class="actions  util-btn-margin-bottom-5">
                                                <a href="<?php echo $this->request->webroot; ?>clients/edit/41?view">Huron Services Group</a>
                                            </td>
