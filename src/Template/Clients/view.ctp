...
<h3 class="page-title"><?php echo $client->company_name; ?></h3>
<div class="page-bar">
				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="list-unstyled profile-nav">
							...
							$types = $Manager->enum_profile_types(true, $language);
							$counter = 0;
							 ...
							 foreach($contact as $c){
									?>
							 <li>
								<a href="<?= $this->request->webroot;?>profiles/view/<?= $c->id; ?>">
									<?= $c->username; //echo $types[$p->profile_type]; ?>
								</a>
							</li>
									<?php
								}
							...
							<div class="col-md-4">
								<div class="portlet sale-summary">
									<div class="portlet-title">
										<div class="caption">
											 <?= ucfirst($settings->client); //translateme?> Summary
										</div>
										<div class="tools">
								...
								<ul class="list-unstyled">
											...
											<li>
												...
												<?= ucfirst($settings->profile);?>s <i class="fa fa-img-down"></i>
												</span>
												<span class="sale-num">
												<?= $counter; ?> </span>
											</li>
